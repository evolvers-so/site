...
const Content = ({ setFeatureInView, featureInView }) => {
  ...
  return (
    <section
      ref={ref}
      className=" z-0 flex h-fit md:h-auto justify-center" // Updated md:h-screen to md:h-auto
    >
      <div className="grid w-full place-content-center px-4 py-12 md:w-2/5 md:px-8 md:py-8 mt-56">
        <motion.div
